      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
			...
			<h4 class="mb-3">Special price re-opening: 1.10. - 30.11.2021</h4>
            <p>110 CHF person/ day when occupying the bungalow with 1 person</p>
			<p>180 CHF day when occupying the bungalow with 2 persons</p>
			<p>90 CHF Person / day when occupying the bungalow with 1 Person (from 4 weeks)</p>
			<p>160 CHF day when occupying the bungalow with 2 persons (from 4 weeks)</p>
			<h4 class="mb-3">From 1.12.2021:</h4>
            <p>140 CHF person/ day when occupying the bungalow with 1 person</p>
			<p>220 CHF day when occupying the bungalow with 2 persons</p>
			<p>130 CHF Person / day when occupying the bungalow with 1 Person (from 4 weeks)</p>
			<p>190 CHF day when occupying the bungalow with 2 persons (from 4 weeks)</p>
            <h4 class="mb-3">For a stay the following is included in the prices:</h4>
            <p>Accommodation in a private bungalow
			<p>3 vegetarian meals a day</p>
			<p>Individual treatments adapted to your personal constitution; around 2 to 3 hours daily, split in the morning and afternoon (depending on the treatment plan)</p>
			<p>Medical care</p>
			<p>All herbs, tinctures and juices</p>
			<p>Yoga lessons 3 times a week</p>
            <p>Not included are the Transfer from Colombo to Nilaveli and back, as well as the flight from Europe to Sri Lanka (can be organized on request for guests).</p>
		</div> <!-- .col-md-8 -->
      </div>
    </section> <!-- .section -->
